...
------------------------------------------------------------------------
    ...
    clk_en2 : entity work.clock_enable -- for shift array 
        generic map(
            -- FOR SIMULATION, CHANGE THIS VALUE TO 100
            -- FOR IMPLEMENTATION, KEEP THIS VALUE TO 20,000
            ...
            if (reset = '1') then
                ...
                case s_cnt1 is
                    ...
                    when "001" =>
                        ...
                        data_i2 <= data_i (3 downto 0); 
                        
                    when others =>
                        dp_o  <= dp_i(0);
                        dig_o <= "11111110";
                       -- s_hex <= data_i (3 downto 0);
                       s_hex <= data_i2; -- (3 downto 0);
